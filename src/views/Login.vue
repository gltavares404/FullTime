...
<template>
    ...
    <ul class="background">
        <div class="img-forms" style="display: flex; align-items: center; justify-content: center; width: 300px; padding-left: 780px; padding-top: 140px;" >
            <img src="/src/img/logo.png" style="width: 220px; height: 140px;">
